                     ...
                     <div class="accordion">
                         <div class="accordion_inner">
                             <div class="accordion_trigger">
                                 <h4 class="accordion_heading"><?php echo esc_html($heading); ?></h4>
                             ...
                             <div class="accordion_txt">
                                 <div class="accordion_content_inner">
                                     <div class="text-size-small margin-bottom margin-custom1"><?php echo esc_html($text); ?></div>
                                     <?php if ($button_link) : ?>
                                         <a href="<?php echo esc_url($button_link); ?>" class="button is-icon w-inline-block">
                                             <div class="btn_text"><?php echo esc_html($button_text); ?></div>
